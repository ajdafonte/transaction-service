...
class CreateTransactionTest {
  ...
  @BeforeEach
  void setUp() {
    this.createTransaction = new CreateTransaction(terminalFinder);
  }

  @Test
  void shouldCreateTransaction() {
    var terminal = new Terminal(TERMINAL_ID, TERMINAL_THREAT_SCORE);
    var request =
  ...
  @Test
  void shouldNotCreateTransactionWhenTerminalNotFound() {
